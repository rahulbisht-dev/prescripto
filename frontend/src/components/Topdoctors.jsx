...
const Topdoctors = () => {
  ...
  return (
    <div className="flex flex-col items-center gap-4 my-16 text-gray-900 md:mx-10">
        ...
        <p className="sm:w-1/3 text-center txt-sm">Simply Browse Through our extensive list of trusted doctors.</p>
        <div className="w-full opgrid gap-4 pt-5 gap-y-6 px-3 sm:px-0">
